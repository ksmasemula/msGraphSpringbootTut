...
public class Utilities {
    ...
    public static Map<String,String> graphUserProperties(OAuth2AuthorizedClient graphAuthorizedClient) {
        ...
        requestOptions.add(new QueryOption("expand", "fields(select=Title,field_1,field_2,field_3)"));

        // com.microsoft.graph.models.List items = graphServiceClient.sites("12482045-dd5b-4811-aeca-b423f3392b78").lists("3c3f7b1a-a878-4710-bb45-6fe819d02831").buildRequest( requestOptions ).get();

        ListItemCollectionPage items = graphServiceClient.sites("12482045-dd5b-4811-aeca-b423f3392b78").lists("3c3f7b1a-a878-4710-bb45-6fe819d02831").items()
        .buildRequest( requestOptions )
        .get();

        // System.out.print(items.displayName);
        System.out.print(items.getCurrentPage().get(0).fields.additionalDataManager().values());
        ...
        if (user == null) {
            ...
            // userProperties.put("Items Id", items.toString());
        }
